    ...
    <div class="col-12">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center">
            ...
            <div class="mt-3 mt-md-0">
                <!-- Tombol disesuaikan ke profile.index -->
                <a href="{{ route('profile.index') }}" class="btn btn-white border bg-white shadow-sm rounded-pill px-4 py-2 text-dark" style="transition: all 0.2s;">
