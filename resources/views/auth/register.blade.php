    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            background:radial-gradient(circle at 50% 30%,var(--bg-secondary) 0%,var(--bg) 100%);
            min-height:100vh;
            margin:0;
            display:flex;
            align-items:center;
        ...
        html[data-bs-theme="dark"] body {
            background:radial-gradient(circle at 50% 30%,#172235 0%,#0F172A 100%);
            color:var(--text);
        }
    ...
    <div class="register-wrapper">
        <div class="register-card">
            <div class="register-header">
                ...
                <h3 class="register-title mb-2">Buat Akun</h3>
