                    ...
                    <form action="{{ route('admin.questions.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group @error('question_text') is-invalid-group @enderror">
                                ...
                                <textarea class="form-control @error('question_text') is-invalid @enderror" 
                                          ...
                                          name="question_text" 
                                          rows="4" 
                                          placeholder="Tuliskan pernyataan atau pertanyaan di sini..."
                        ...
                        <div class="mb-5">
                            ...
                            <div class="input-group @error('category') is-invalid-group @enderror">
                                ...
                                <select class="form-select @error('category') is-invalid @enderror" 
                                    ...
                                    <option value="depression" {{ old('category') == 'depression' ? 'selected' : '' }}>Depresi (Depression)</option>
                                    <option value="anxiety" {{ old('category') == 'anxiety' ? 'selected' : '' }}>Kecemasan (Anxiety)</option>
                                    <option value="stress" {{ old('category') == 'stress' ? 'selected' : '' }}>Stres (Stress)</option>
                                </select>
                            </div>
                            @error('category')
                                <div class="invalid-feedback d-block mt-2 px-1">{{ $message }}</div>
                        ...
                        <div class="d-flex justify-content-between action-buttons border-top pt-4 mt-2">
                            ...
                            <button type="submit" class="btn-action btn-save">
                                <i class="bi bi-floppy-fill me-2"></i> Simpan Pertanyaan
                            </button>
                        </div>
